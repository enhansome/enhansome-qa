# Awesome Question Answering with stars
...
* DilBert: Delaying Interaction Layers in Transformer-based Encoders for Efficient Open Domain Question Answering (2020)
  * github: <https://github.com/wissam-sib/dilbert> ⭐ 16 | 🐛 0 | 🌐 Python | 📅 2020-10-23
...
* ProQA: Resource-efficient method for pretraining a dense corpus index for open-domain QA and IR. (2020)
  * github: <https://github.com/xwhan/ProQA> ⭐ 43 | 🐛 4 | 🌐 Python | 📅 2023-06-12
...
* Papers
  ...
  * ["Capturing Semantic Similarity for Entity Linking with Convolutional Neural Networks"](http://nlp.cs.berkeley.edu/pubs/FrancisLandau-Durrett-Klein_2016_EntityConvnets_paper.pdf), Matthew Francis-Landau, Greg Durrett and Dan Klei, NAACL-HLT 2016.
    * <https://GitHub.com/matthewfl/nlp-entity-convnet> ⭐ 58 | 🐛 2 | 🌐 Jupyter Notebook | 📅 2016-07-19
...
* [BiDAF](https://github.com/allenai/bi-att-flow) ⭐ 1,546 | 🐛 74 | 🌐 Python | 📅 2023-05-31 - Bi-Directional Attention Flow (BIDAF) network is a multi-stage hierarchical process that represents the context at different levels of granularity and uses bi-directional attention flow mechanism to obtain a query-aware context representation without early summarization.
...
* [DrQA](https://github.com/hitvoice/DrQA) ⭐ 400 | 🐛 9 | 🌐 Python | 📅 2022-03-26 - DrQA is a system for reading comprehension applied to open-domain question answering.
  ...
  * [Paper](#drqa)
* [R-Net-in-Keras](https://github.com/YerevaNN/R-NET-in-Keras) ⭐ 177 | 🐛 14 | 🌐 Python | 📅 2017-12-26 - R-NET re-implementation in Keras.
...
* [Question Answering with Knowledge Bases, Web and Beyond](https://github.com/scottyih/Slides/blob/master/QA%20Tutorial.pdf) ⭐ 36 | 🐛 0 | 📅 2019-08-06 - By Scott Wen-tau Yih & Hao Ma | Microsoft Research | 2016.
...
* [NarrativeQA](https://github.com/deepmind/narrativeqa) ⭐ 518 | 🐛 0 | 🌐 Shell | 📅 2020-04-15
...
* [NewsQA](https://github.com/Maluuba/newsqa) ⚠️ Archived
  * A machine comprehension dataset
  * Paper: <https://arxiv.org/pdf/1611.09830.pdf>
* [GraphQuestions](https://github.com/ysu1989/GraphQuestions) ⭐ 94 | 🐛 0 | 🌐 ReScript | 📅 2022-12-28
  * On generating Characteristic-rich Question sets for QA evaluation.
* [CODAH Dataset](https://github.com/Websail-NU/CODAH) ⭐ 22 | 🐛 0 | 🌐 Python | 📅 2022-10-29
